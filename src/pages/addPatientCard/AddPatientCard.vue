        ...
        <div>
            <ul class="apInfo">
                <li class="clearfix">
                    <span>姓名</span>
                    <span>
                        <input type="text" name="" placeholder="请输入姓名" :value="realname" v-on:input="onInputChangeRealName($event.target.value)">
                ...
                <li class="clearfix">
                    <span>身份证</span>
                    <span>
                        <input  type="text"   name="" placeholder="请输入身份证号" :value="ID_no" v-on:input="onInputChangeIDNo($event.target.value)">
                ...
                <li class="clearfix">
                    ...
                    <template v-if="this.$route.params.realname ? true : false">
                        <span>
                            <input  type="tel"  name="" placeholder="请输入手机号" :value="mobile"  >
                            <!-- <img v-if="!mobile"  src="../../common/images/departmentlist/arrowIcon.png" alt="" /> -->
                        </span>
                    </template>
                    <template v-if="this.$route.params.realname ? false : true">
                        <span>
                            <input  type="tel" name="" placeholder="请输入手机号" :value="mobile" v-on:input="onInputChangeMobile($event.target.value)">
                            <!-- <img v-if="!mobile" src="../../common/images/departmentlist/arrowIcon.png" alt="" /> -->
                        </span>
                    </template>
                </li>
    ...
    methods: {
        ...
        saveInfo(e) {
            ...
            if (this.patientId != '') {
                ...
                //         name:'马小跳',
                //         mobile:'18008649568',
                //         id:'4201061992015342524'
                //     }
                // })
                http
                    .post(`/api/user/add_patient?access_token=`+ access_token, {
                        ID_no: this.ID_no,
                        mobile: this.mobile,
                        realname: this.realname,
                        code: this.$refs.vertifyCode.value,
        ...
        getMessgeCode($event) {
            ...
            if (this.patientId != '') {
                ...
                if (this.getCode) {
                    ...
                    http
                        .fetch('/api/user/send_sms_code_by_id', {
                            id: this.patientId,
                        })
                        .then(res => {
                            this.msg = res;
...
#addpatient .apInfo > li span:nth-of-type(2) input:-moz-placeholder{
  text-align: right;
}
#addpatient .apInfo > li span:nth-of-type(2) input::-moz-placeholder{
  text-align: right;
